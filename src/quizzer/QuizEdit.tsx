...
export const QuizEdit = ({
    ...
    const editQuestion = (questionId: number, newQuestion: Question) => {
        setNewQuiz({
            ...newQuiz,
            questionList: newQuiz.questionList.map( (q: Question) => q.id === questionId ? newQuestion : q)
        });
    };
    ...
    const removeQuestion = (questionId: number) => {
        setNewQuiz({
            ...newQuiz,
            questionList: newQuiz.questionList.filter( (q: Question) => q.id !== questionId) //remove question
        });
    };
